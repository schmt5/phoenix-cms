defmodule Content.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      Content.Repo,
      {Ecto.Migrator,
       repos: Application.fetch_env!(:content, :ecto_repos), skip: skip_migrations?()},
      {DNSCluster, query: Application.get_env(:content, :dns_cluster_query) || :ignore},
      {Phoenix.PubSub, name: Content.PubSub},
